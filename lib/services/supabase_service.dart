...
class SupabaseService {
  ...
  // Sync client getter for when you know it's already initialized
  SupabaseClient get syncClient {
    if (!_isInitialized) {
      throw Exception(
          'SupabaseService not yet initialized. Use client getter instead.');
    }
    return _client;
  }
  ...
  Stream<AuthState> get authStateStream =>
      _isInitialized ? _client.auth.onAuthStateChange : const Stream.empty();
}
